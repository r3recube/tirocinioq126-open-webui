					...
					>
						...
						<div
							...
							class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
								...
								: ' border-gray-100/30 dark:border-gray-850/30 hover:border-gray-200 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800'}  transition px-1 bg-white/5 dark:bg-gray-500/5 backdrop-blur-sm dark:text-gray-100 recube:border-[#EBB700] recube:hover:border-[#EBB700] recube:focus-within:border-[#EBB700]"
								...
								<div class="ml-1 self-end flex items-center flex-1 max-w-[80%]">
									...
									>
										<div
											...
											class="bg-transparent hover:bg-gray-100 text-gray-700 dark:text-white dark:hover:bg-gray-800 recube:text-[#EBB700] recube:hover:bg-[#EBB700]/10 rounded-full size-8 flex justify-center items-center outline-hidden focus:outline-hidden"
										>
											...
											{#if $_user?.role === 'admin' || ($_user?.permissions?.chat?.stt ?? true)}
												...
												<Tooltip content={$i18n.t('Dictate')}>
													<button
														...
														class=" bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black dark:hover:bg-gray-100 recube:bg-[#EBB700] recube:text-black recube:hover:text-black recube:hover:bg-[#EC9400] transition rounded-full p-1.5 self-center mr-0.5"
														type="button"
														on:click={async () => {
															try {
										...
										{#if prompt === '' && files.length === 0 && ($_user?.role === 'admin' || ($_user?.permissions?.chat?.call ?? true))}
											<div class=" flex items-center">
												...
												<Tooltip content={$i18n.t('Voice mode')}>
													<button
														class=" bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black dark:hover:bg-gray-100 recube:bg-[#EBB700] recube:text-black recube:hover:text-black recube:hover:bg-[#EC9400] transition rounded-full p-1.5 self-center"
														type="button"
														on:click={async () => {
												...
												>
													<button
														...
														class="{!(prompt === '' && files.length === 0) || uploadPending
															? 'bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black dark:hover:bg-gray-100 recube:bg-[#EBB700] recube:text-black recube:hover:bg-[#EC9400] recube:hover:text-black '
